...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int kRearLeftDrivingCanId = 5; //3
    public static final int kFrontRightDrivingCanId = 1; //7
    public static final int kRearRightDrivingCanId = 7; //5

    public static final int kFrontLeftTurningCanId = 4; //2
    public static final int kRearLeftTurningCanId = 6; //4
    public static final int kFrontRightTurningCanId = 2; //8
